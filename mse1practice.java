...
//		long len=ss.count();
//		Stream<Integer> k=list.stream();
//		List<Integer>result=k.limit(len-2).toList();
//		System.out.println(result);
//	}
//}
/////////////
...
////	a+b
////			);
//	String l=list.stream().reduce("",(a,b)->a+b);
//	System.out.println(l);
//}
//}
...
//////////////////use reduce to reverse a string not complete wrong ques
//class mse1practice{
//public static void main(String[]args) {
//	String k="sakshi";
...
//}
//}
//////////////////multiple list into single list wrong ques 
//class mse1practice{
//public static void main(String[]args) {
...
//	
//}}
///////////////////factorial of a no. using reduce 
class mse1practice{
public static void main(String[]args) {
	List<Integer>list=Arrays.asList(1,2,34,5,6,7);
	Integer k=list.stream().reduce(1,(a,b)->{
		while(b>=1) {
			b=b*b-1;
			b--;
